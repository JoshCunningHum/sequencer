...
export type QueryInfer<Schema extends AnyObject> = yup.InferType<
...
interface QueryParams<Schema extends AnyObject = Record<string, never>> {
    title?: string;
    description?: string;
...
export interface ConfirmParams<Schema extends AnyObject>
