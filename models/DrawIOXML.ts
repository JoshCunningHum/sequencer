...
export type DIOMxfile = XMLNode & {
    ...
    elements: [DIODiagram, ...DIODiagram[]];
};

export const isMxfile = (node?: XMLNode): node is DIOMxfile => node?.name === "mxfile";
...
export type DIODiagram = XMLNode & {
    ...
    elements: [DIOMxGraphModel, DIOMxGraphModel[]];
};

export const isDiagram = (node: XMLNode): node is DIODiagram => node.name === "diagram";
    ...
    elements: [
        {
            type: "element";
            name: "root";
            elements: [DIOMxCell, DIOMxCell, ...DIOMxCell[]];
        },
    ];
};
...
export const isMxCell = (node: XMLNode): node is DIOMxCell => node.name === "mxCell";
...
//#region DrawIO Helpers

export const isMxGeometry = (node: XMLNode): node is DIOMxGeometry => node.name === "mxGeometry";
